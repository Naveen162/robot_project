...
TC1 Sign Up
    ...
    OpenApplication    remote_url = http: // localhost: 4723 / wd / hub
    ...
    Input Text xpath = // (android.widget.EditText[ @ resource - id='android:id/numberpicker_input'])[1]

    Aug Wait Until Page Contains Element xpath = (// android.widget.EditText[@ resource-id='android:id/numberpicker_input'])[2]30s
    ...
    Element Should Contain Text xpath = // android.widget.TextView[ @ text = 'Invalid password']Invalidpassword
